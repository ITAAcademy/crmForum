...
*/
	            ...
	            function DraggerOver() {
	                $dragger.css("background", "url(modules/slider/round_custom_scrollbar_bg_over.png)");
	            }

	            function DraggerOut() {
	                $dragger.css("background", "url(modules/slider/round_custom_scrollbar_bg.png)");
	            }
	        }
	...
	$outer_container_a.click(function(event) {
	    ...
	    var $this = this;
	    if ($(this).children(".selected").css("display") == "block") {
	        //call set
	        browerCall(event);
	    }
	...
	var images = ["modules/slider/ajax-loader_dark.gif", "modules/slider/round_custom_scrollbar_bg_over.png"];
